...
| High availability                              | **None**                                                     | Receipts are single-writer per replica. Evidence export ships receipts and signed checkpoints off the replica; multi-replica sequencing is a roadmap item     |
