...
| Known detection gaps?                        | Yes, quantified                                          | Encoded and obfuscated representations are decoded before matching (7/7 and 7/10 on the adversarial corpus). Spelled-out digits and IPv6 are not detected, and person names and addresses need the semantic detector |
